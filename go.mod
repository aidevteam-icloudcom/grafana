...
require (
	...
	github.com/grafana/grafana/pkg/apimachinery v0.0.0-20240808164224-787abccfbc9e // @grafana/grafana-app-platform-squad
...
require (
	...
	github.com/grafana/grafana/pkg/storage/unified/resource v0.0.0-20240819170100-ac5ebe6e4d16 // @grafana/grafana-search-and-storage
