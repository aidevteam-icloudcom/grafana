...
require (
	...
	github.com/urfave/cli/v2 v2.27.3 // @grafana/grafana-backend-group
...
require (
	...
	github.com/grafana/grafana/pkg/storage/unified/resource v0.0.0-20240805175457-b6de9e9d3c40 // @grafana/grafana-search-and-storage
