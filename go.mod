...
require (
	...
	cloud.google.com/go/storage v1.42.0 // @grafana/grafana-backend-group
	...
	google.golang.org/api v0.183.0 // @grafana/grafana-backend-group
...
require (
	...
	google.golang.org/genproto v0.0.0-20240528184218-531527333157 // indirect; @grafana/grafana-backend-group
